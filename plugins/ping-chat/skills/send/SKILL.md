...
- `gchat_user_id` (optional) — your Google Chat user ID (e.g., `users/123456789012345678`). When set, you'll be @mentioned in the posted message so you get notified when someone replies to the thread.
